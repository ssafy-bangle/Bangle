...
const deriveAESkey = async (password: string) => {
  ...
  const serverPublicKey =
    '3d2c953f0eabd4851906dce48a318bd8e55e3aae4710da55e820b7cd81d6a8ed468da0b5e063419cf5b73ea7823df23d2df09651a76d076319b99051cffe36ae';
  ...
  const derived = pbkdf2(sha256, toHexString(sharedSecret), userPublicKey.slice(0, 16), { c: 1000, dkLen: 32 });
  return derived;
};
